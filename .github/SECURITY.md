...
Report privately via [GitHub Security Advisories](https://github.com/elloloop/identity/security/advisories/new).
...
- Privilege escalation (non-admin → admin, cross-user data access).
- Email enumeration, account-takeover vectors.
- Token forgery, signature-verification bypass, JWKS spoofing.
- Information disclosure (PII, tokens, password hashes) in responses or logs.
