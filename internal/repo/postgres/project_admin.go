...
// ProjectCredentialByPublicID is the postgres driver's
...
func (s *ProjectStore) ProjectCredentialByPublicID(ctx context.Context, publicID string) (*service.AdminProjectCredential, error) {
