...
// user.deactivated + user.deleted events — so external services (a downstream
// consumer relay) cascade identically to an admin delete. Returns the number of accounts
// purged.
//
