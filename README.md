...
> migration in this release**; a fresh install is recommended. See
> [`docs/UPGRADE.md`](./docs/UPGRADE.md) for the full upgrade guide (and an
> unsupported, best-effort bridge for the rare legacy-data case). Postgres
> row-level-security hardening remains a tracked v1.1 follow-up. What changed:
>
