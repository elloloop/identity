...
const file_identity_schema_schema_proto_rawDesc = "" +
	...
	"\flast_used_at\x18\t \x01(\x03B\x11\xb2\xbb\x18\r:\ttimestamp`\x01R\n" +
	"lastUsedAt:I\xa2\xbb\x18E\b\x14:\auser_idR8A WebAuthn/FIDO2 passkey credential registered by a user\"\xe9\x02\n" +
	"\x10PasskeyChallenge\x12*\n" +
	"\tchallenge\x18\x01 \x01(\tB\f\xb2\xbb\x18\b\b\x01\x18\x01`\x01h\x01R\tchallenge\x12(\n" +
	"\auser_id\x18\x02 \x01(\tB\x0f\xb2\xbb\x18\v\x18\x01:\x03ref@\x01`\x01R\x06userId\x12J\n" +
	...
	"\aused_at\x18\x05 \x01(\x03B\x11\xb2\xbb\x18\r:\ttimestamp`\x01R\x06usedAt:?\xa2\xbb\x18;\b\x18:\auser_idR.A one-time recovery code for 2FA backup access\"\x92\x02\n" +
	...
	"resolvedAt\x122\n" +
	"\n" +
	"created_at\x18\t \x01(\x03B\x13\xb2\xbb\x18\x0f\x18\x01:\ttimestamp`\x01R\tcreatedAt:L\xa2\xbb\x18H\b\x1c0\x01RBA help request from a user who cannot log in, resolved by an admin\"\xdc\x02\n" +
	"\x16EmailVerificationToken\x12+\n" +
	"\n" +
	"token_hash\x18\x01 \x01(\tB\f\xb2\xbb\x18\b\b\x01\x18\x01`\x01h\x01R\ttokenHash\x12(\n" +
	"\auser_id\x18\x02 \x01(\tB\x0f\xb2\xbb\x18\v\x18\x01:\x03ref@\x01`\x01R\x06userId\x12 \n" +
	...
	"consumedAt:A\xa2\xbb\x18=\b\x1d:\auser_idR0A short-lived token for email verification flows\"\x87\x03\n" +
